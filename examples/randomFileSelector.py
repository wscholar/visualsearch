...
print("[INFO] Trying to copy " + numberoffiles + " of files from " + inputdataset + " to " + copytodir)
filesCopied =0
...
for x in range(0, numberoffiles):
    ...
    cv2.imwrite(copytodir,image)  
    filesCopied+=1;
 
print("[INFO] Randomly Copied " + filesCopied + " files to " + copytodir)
